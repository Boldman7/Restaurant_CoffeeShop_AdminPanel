                        ...
                        <div class="panel">
                          <div class="white-box">
                            <div class="panel-heading">All orders list</div>
                             <?php $attributes = array('id' => 'form_validation', 'style'=>'margin-top: 13px; margin-bottom: 15px;','name'=>'add_coupon','class'=>'form-sample'); echo form_open_multipart('Admin/deletedOrder', $attributes); ?>
                                <div class="row">
                                 <div class="col-md-12">
                                    <div class="col-sm-4">
                            ...
                            <div class="table-responsive">
                              <table id="deletedOrder" class="deletedOrder display nowrap table table-hover table-striped table-bordered dataTable" cellspacing="0" width="100%" role="grid" aria-describedby="example23_info" style="width: 100%;">
                                    <thead>
                                      <tr role="row">
                                        <th>Sno.</th>
                                        <th>Date</th>
                                    ...
                                    if(count($invoice))
                                    {
                                      ...
                                      <td style="display: none;"><?php $operator = $this->Api_model->getUserInfo('staff',array('staff_pub_id'=>$invoiceData->operator_pub_id));
                                      ...
                                      <td><label class="badge badge-warning">Deleted</label></td>
                                      </tr>
